...
\begin{itemize}
 \item Estimating the causal effects of unemployement on physical and mental health outcomes using g-methods with administrative data.
\end{itemize}
} \\
\\
...
```{r gstext, include = F, echo = F, eval = F}
